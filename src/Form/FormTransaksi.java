...
public class FormTransaksi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setFont(new java.awt.Font("Agency FB", 1, 19)); // NOI18N
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 102, 102), 2), "Bayar", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Agency FB", 0, 18), new java.awt.Color(0, 102, 102))); // NOI18N
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(t_kembali, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addContainerGap())
        );
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/cari.png"))); // NOI18N
...
//                no++;
    ...
    private void btn_bayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_bayarActionPerformed
           ...
           String nis = t_nis_bayar.getText().toString();
           ...
           int tunggakanHitung = tunggakan - bayar;
            ...
            String tunggakanFix = "0";
            if (tunggakanHitung < 0) {
               tunggakanFix = "0"; 
            } else {
               tunggakanFix = Integer.toString(tunggakanHitung);
            }
        try {
            String sql ="UPDATE transaksi SET tanggal_pembayaran=?, total_tunggakan=?, total_pembayaran=? WHERE nis=?";
            PreparedStatement st = conn.prepareStatement(sql);
            st.setString(1, dateNow);
            st.setString(2, tunggakanFix);
            st.setString(3, total_pembayaran);
            st.setString(4, nis);
...
//      Hanya boleh diisi angka
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        if(confirm == JOptionPane.YES_OPTION){
            String id = tbl_transaksi.getValueAt(selectedRow, 0).toString();
            String nis = tbl_transaksi.getValueAt(selectedRow, 2).toString();
            
            try {
                String sql="DELETE FROM transaksi WHERE id=? AND nis=?";
                PreparedStatement st = conn.prepareStatement(sql);
                st.setString(1,id);
                st.setString(2,nis);
    ...
    private void t_cariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_t_cariKeyTyped
        ...
        try {
            String sql = "Select * From transaksi WHERE nama LIKE ? OR nis LIKE ?";
            PreparedStatement st = conn.prepareStatement(sql);
            st.setString(1,"%" + cari + "%" );
            st.setString(2,"%" + cari + "%" );
            ...
            while(rs.next()){
                ...
                Object[] rowData = {id,tanggal,nis,nama,kelas,tahun_ajaran,total_tunggakan,total_pembayaran};
                model.addRow(rowData);
            }
            rs.close();
            st.close();
